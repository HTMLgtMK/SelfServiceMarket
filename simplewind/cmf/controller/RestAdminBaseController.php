...
class RestAdminBaseController
{
    ...
    private function _initUser()
    {
        ...
        $auser = Db::name('adminstrator_token')
            ->alias('a')
            ->field('b.*')
        ...
        if (!empty($user)) {
            $this->adminstrator     = $user;
            $this->adminstratorId   = $user['id'];
        }
