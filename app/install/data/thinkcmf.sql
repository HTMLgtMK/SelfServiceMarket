...
(110, 49, 1, 1, 10000, 'admin', 'Adminstrator', 'index', '', '管理员', '', '管理员管理'),
(111, 110, 1, 0, 10000, 'admin', 'Adminstrator', 'add', '', '管理员添加', '', '管理员添加'),
(112, 110, 2, 0, 10000, 'admin', 'Adminstrator', 'addPost', '', '管理员添加提交', '', '管理员添加提交'),
(113, 110, 1, 0, 10000, 'admin', 'Adminstrator', 'edit', '', '管理员编辑', '', '管理员编辑'),
(114, 110, 2, 0, 10000, 'admin', 'Adminstrator', 'editPost', '', '管理员编辑提交', '', '管理员编辑提交'),
(115, 110, 1, 0, 10000, 'admin', 'Adminstrator', 'userInfo', '', '个人信息', '', '管理员个人信息修改'),
(116, 110, 2, 0, 10000, 'admin', 'Adminstrator', 'userInfoPost', '', '管理员个人信息修改提交', '', '管理员个人信息修改提交'),
(117, 110, 2, 0, 10000, 'admin', 'Adminstrator', 'delete', '', '管理员删除', '', '管理员删除'),
(118, 110, 2, 0, 10000, 'admin', 'Adminstrator', 'ban', '', '停用管理员', '', '停用管理员'),
(119, 110, 2, 0, 10000, 'admin', 'Adminstrator', 'cancelBan', '', '启用管理员', '', '启用管理员'),
...
(164, 163, 1, 0, 10000, 'market', 'AdminMarketPost','add','', '添加岗位', '', '添加岗位'),
(165, 163, 2, 0, 10000, 'market', 'AdminMarketPost','addPost','', '添加岗位提交', '', '添加岗位提交'),
(166, 163, 1, 0, 10000, 'market', 'AdminMarketPost','edit','', '编辑岗位', '', '编辑岗位'),
(167, 163, 2, 0, 10000, 'market', 'AdminMarketPost','editPost','', '编辑岗位提交', '', '编辑岗位提交'),
(168, 163, 2, 0, 10000, 'market', 'AdminMarketPost','delete','', '删除岗位', '', '删除岗位'),
(169, 162, 1, 1, 80, 'market', 'AdminMarketCheckIn','index','', '签到管理', '', '签到列表'),
(170, 169, 1, 0, 10000, 'market', 'AdminMarketCheckIn','add','', '添加签到', '', '添加签到'),
(171, 169, 2, 0, 10000, 'market', 'AdminMarketCheckIn','addPost','', '添加签到提交', '', '添加签到提交'),
(172, 162, 1, 1, 90, 'market', 'AdminMarketAccount','index','', '财务管理', '', '财务管理主页'),
(173, 172, 1, 0, 10000, 'market', 'AdminMarketAccount','add','', '新增出账', '', '新增出账'),
(174, 172, 2, 0, 10000, 'market', 'AdminMarketAccount','addPost','', '新增出账提交', '', '新增出账提交'),
(175, 162, 1, 1, 100, 'market', 'AdminMarketStore', 'index', '', '店铺管理', '', '店铺管理主页'),
(176, 175, 1, 0, 10000, 'market', 'AdminMarketStore', 'add', '', '添加店铺', '', '添加店铺'),
(177, 175, 2, 0, 10000, 'market', 'AdminMarketStore', 'addPost', '', '添加店铺提交', '', '添加店铺提交'),
(178, 175, 1, 0, 10000, 'market', 'AdminMarketStore', 'edit', '', '编辑店铺', '', '编辑店铺'),
(179, 175, 2, 0, 10000, 'market', 'AdminMarketStore', 'editPost', '', '编辑店铺提交', '', '编辑店铺提交'),
(180, 175, 2, 0, 10000, 'market', 'AdminMarketStore', 'delete', '', '删除店铺', '', '删除店铺'),
(181, 175, 2, 0, 10000, 'market', 'AdminMarketStore', 'close', '', '店铺打烊', '', '店铺打烊'),
(182, 175, 2, 0, 10000, 'market', 'AdminMarketStore', 'open', '', '店铺营业', '', '编辑营业'),
(183, 162, 1, 1, 110, 'market', 'AdminMarketTerminal', 'index', '', '自助终端管理', '', '自助终端管理主页'),
(184, 183, 1, 0, 10000, 'market', 'AdminMarketTerminal', 'add', '', '添加终端', '', '添加终端'),
(185, 183, 2, 0, 10000, 'market', 'AdminMarketTerminal', 'addPost', '', '添加终端提交', '', '添加终端提交'),
(186, 183, 1, 0, 10000, 'market', 'AdminMarketTerminal', 'edit', '', '编辑终端', '', '编辑终端'),
(187, 183, 2, 0, 10000, 'market', 'AdminMarketTerminal', 'editPost', '', '编辑终端提交', '', '编辑终端提交'),
(188, 183, 2, 0, 10000, 'market', 'AdminMarketTerminal', 'delete', '', 'delete终端', '', 'delete终端'),
(189, 183, 2, 0, 10000, 'market', 'AdminMarketTerminal', 'ban', '', '停用终端', '', '停用终端'),
(190, 183, 2, 0, 10000, 'market', 'AdminMarketTerminal', 'cancelban', '', '启用终端', '', '启用终端'),
(191, 162, 1, 1, 120, 'market', 'AdminMarketProvider', 'default', '', '供应管理', '', '供应商管理'),
(192, 191, 1, 1, 130, 'market', 'AdminMarketProvider', 'index', '', '供应商管理', '', '供应商管理'),
(193, 192, 1, 0, 10000, 'market', 'AdminMarketProvider', 'add', '', '添加供应商', '', '添加供应商'),
(194, 192, 2, 0, 10000, 'market', 'AdminMarketProvider', 'addPost', '', '添加供应商提交', '', '添加供应商提交'),
(195, 192, 1, 0, 10000, 'market', 'AdminMarketProvider', 'edit', '', '编辑供应商', '', '编辑供应商'),
(196, 192, 2, 0, 10000, 'market', 'AdminMarketProvider', 'editPost', '', '编辑供应商提交', '', '编辑供应商提交'),
(197, 192, 2, 0, 10000, 'market', 'AdminMarketProvider', 'delete', '', '删除供应商', '', '删除供应商'),
(198, 191, 1, 1, 140, 'market', 'AdminMarketProviderGoods', 'index', '', '供应商品管理', '', '供应商品管理'),
(199, 198, 1, 0, 10000, 'market', 'AdminMarketProviderGoods', 'add', '', '添加供应商品', '', '添加供应商品'),
(200, 198, 2,0, 10000, 'market', 'AdminMarketProviderGoods', 'addPost', '', '添加供应商品提交', '', '添加供应商品提交'),
(201, 198, 1, 0, 10000, 'market', 'AdminMarketProviderGoods', 'edit', '', '编辑供应商品', '', '编辑供应商品'),
(202, 198, 2, 0, 10000, 'market', 'AdminMarketProviderGoods', 'editPost', '', '编辑供应商品提交', '', '编辑供应商品提交'),
(203 , 162, 2, 1, 150, 'market', 'AdminMarketGoods', 'default', '', '商品管理', '', '商品管理'),
(204 , 203, 1, 1, 160, 'market', 'AdminMarketGoods', 'indexGoodsType', '', '商品类管理', '', '商品类管理'),
(205 , 204, 1, 0, 10000, 'market', 'AdminMarketGoods', 'addGoodsType', '', '添加商品类', '', '添加商品类'),
(206 , 204, 2, 0, 10000, 'market', 'AdminMarketGoods', 'addGoodsTypePost', '', '添加商品类提交', '', '添加商品类提交'),
(207, 204, 1, 0, 10000, 'market', 'AdminMarketGoods', 'editGoodsType', '', '编辑商品类', '', '编辑商品类'),
(208 , 204, 2, 0, 10000, 'market', 'AdminMarketGoods', 'editGoodsTypePost', '', '编辑商品类提交', '', '编辑商品类提交'),
(209 , 204, 1, 0, 10000, 'market', 'AdminMarketGoods', 'deleteGoodsType', '', '下架商品类', '', '下架商品类'),
(210 , 203, 1, 1, 170, 'market', 'AdminMarketGoods', 'indexGoods', '', '商品管理', '', '商品管理'),
(211 , 210, 1, 0, 10000, 'market', 'AdminMarketGoods', 'addGoods', '', '添加商品', '', '添加商品'),
(212 , 210, 2, 0, 10000, 'market', 'AdminMarketGoods', 'addGoodsPost', '', '添加商品提交', '', '添加商品提交'),
(213 , 210, 1, 0, 10000, 'market', 'AdminMarketGoods', 'editGoods', '', '编辑商品', '', '编辑商品'),
(214 , 210, 2, 0, 10000, 'market', 'AdminMarketGoods', 'editGoodsPost', '', '编辑商品提交', '', '编辑商品提交'),
(215 , 210, 1, 0, 10000, 'market', 'AdminMarketGoods', 'deleteGoods', '', '下架商品', '', '下架商品'),
(216, 162, 1, 1, 180, 'market', 'AdminMarketSale', 'default', '', '销售管理', '', '销售管理'),
(217, 216, 1, 1, 190, 'market', 'AdminMarketSaleDiscount', 'index', '', '折扣管理', '', '折扣管理'),
(218, 217, 1, 0, 10000, 'market', 'AdminMarketSaleDiscount', 'add', '', '添加折扣', '', '添加折扣'),
(219, 217, 2, 0, 10000, 'market', 'AdminMarketSaleDiscount', 'addPost', '', '添加折扣提交', '', '添加折扣提交'),
(220, 217, 1, 0, 10000, 'market', 'AdminMarketSaleDiscount', 'edit', '', '编辑折扣', '', '编辑折扣'),
(221, 217, 2, 0, 10000, 'market', 'AdminMarketSaleDiscount', 'editPost', '', '编辑折扣提交', '', '编辑折扣提交'),
(222, 217, 1, 0, 10000, 'market', 'AdminMarketSaleDiscount', 'delete', '', '删除折扣', '', '删除折扣'),
(223, 216, 1, 1, 200, 'market', 'AdminMarketSaleDiscountGoods', 'index', '', '折扣商品管理', '', '折扣商品管理'),
(224, 223, 1, 0, 10000, 'market', 'AdminMarketSaleDiscountGoods', 'add', '', '添加折扣商品 ', '', '添加折扣商品'),
(225, 223, 2, 0, 10000, 'market', 'AdminMarketSaleDiscountGoods', 'addPost', '', '添加折扣商品提交', '', '添加折扣商品提交'),
(226, 223, 1, 0, 10000, 'market', 'AdminMarketSaleDiscountGoods', 'edit', '', '编辑折扣商品', '', '编辑折扣商品'),
(227, 223, 2, 0, 10000, 'market', 'AdminMarketSaleDiscountGoods', 'editPost', '', '编辑折扣商品提交', '', '编辑折扣商品提交'),
(228, 223, 1, 0, 10000, 'market', 'AdminMarketSaleDiscountGoods', 'delete', '', '删除折扣商品', '', '删除折扣商品'),
(229, 216, 1, 1, 210, 'market', 'AdminMarketSale', 'index', '', '交易管理', '', '交易管理'),
(230, 229, 1, 0, 10000, 'market', 'AdminMarketSale', 'cartIndex', '', '购物车管理', '', '购物车管理'),
(231, 229, 1, 0, 10000, 'market', 'AdminMarketSale', 'cartCancel', '', '取消购物车', '', '取消购物车');
